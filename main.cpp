...
int main(void ){
	...
	weightscale weightScale = weightscale(DT, SCK, calSw, 1);	//Data pin, Clock pin, Calibration button, Start button, calibration weight, times of average, maximum tries
